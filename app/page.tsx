...
export default async function Home() {
  ...
  return (
    <main className="flex  flex-col items-center justify-between p-20 ">
      ...
      <div className="flex gap-2  items-center overflow-y-auto mb-4">
       ...
       <div className="flex text-black gap-2">
        ...
        <div className="flex flex-col w-[30%]  text-black  overflow-y-auto gap-2  p-2 ">
          {job.map((job) => (
            <JobCard key={job.id} job={job} />
          ))}
        </div>

        <div className="flex flex-col w-[70%] border rounded-lg  mb-10">
